...
public final class __XMLReaderFactory implements XMLReader {
    ...
    private static void resetScanTracking() {
        try {
            ...
            //skipping this exception, original SAX XMLReaderFactory hasn't helper fields _clsFromJar and _jarread
            __RedirectedUtils.getModuleLogger().trace(e, "Skipping NoSuchFieldException thrown when reseting XMLReaderFactory internal fields");
